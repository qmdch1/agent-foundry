...
const creationTokens=p=>p.runtime==="builtin"?"기본 내장 프로그램":p.creation_tokens==null?"생성 토큰 미집계":`생성 ${Number(p.creation_tokens).toLocaleString()} 토큰`;
