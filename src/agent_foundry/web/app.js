...
const creationTokens=p=>p.creation_tokens==null?"생성 토큰 미집계":`생성 ${p.creation_tokens_estimated?"약 ":""}${Number(p.creation_tokens).toLocaleString()} 토큰`;
